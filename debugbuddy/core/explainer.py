...
class ErrorExplainer:
    """Explain errors using pattern matching with enhanced suggestions"""
    ...
    def explain(self, parsed_error: Dict) -> Dict:
        """Generate human-friendly explanation with examples and suggestions"""
    ...
    def _get_name_suggestions(self, message: str, parsed_error: Dict) -> List[str]:
        """Generate 'did you mean' suggestions for NameError"""
    ...
    def get_code_example(self, error_type: str) -> Optional[str]:
        """Get code example for an error type"""
